...
fs-baby-base:
	docker run repronim/neurodocker generate docker --base ubuntu:xenial --pkg-manager apt --neurodebian os_codename=xenial server=usa-nh --fsl version=5.0.10 method=binaries --minc version=1.9.15 method=binaries > baby/dockerfile.fs-baby-base
